...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    points: [
      ...
      "将来の管理者画面では、削除済み記録の確認・復元に使える設計です。",
    ],
  },
  {
    id: "share",
  ...
  },
  {
    ...
    intro: "Phase 8時点では、ログインとクラウド同期はまだ未実装です。",
    points: [
      "現在の記録はこの端末のlocalStorageに保存されます。",
      "今後のPhaseでSupabase Authを入れると、ユーザーごとにクラウド保存できる予定です。",
      "タイマー中は通信せず、停止後にlocalStorageへ保存してから同期する構成にします。",
  ...
  },
  {
    ...
    points: [
      "Phase 8時点では、画面やデータ同期はまだ追加していません。",
  ...
  },
  {
    ...
    points: [
      "記録が消えたように見える時は、別ブラウザや別端末で開いていないか確認してください。今は端末内保存です。",
