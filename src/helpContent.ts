...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    intro: "ログイン中はユーザーIDでフレンド申請を送り、承認された相手を一覧で管理できます。",
    points: [
      "フレンド機能を使うには、マイページで自分のユーザーIDを設定しておく必要があります。",
      "フレンド画面では相手のユーザーIDを入力して申請できます。@は付けても付けなくても大丈夫です。",
      "届いた申請は通知センター、またはフレンド画面から承認/拒否できます。",
      "未読の申請がある時は、Timer画面の通知アイコンに件数バッジを表示します。通知センターを開くと既読になります。",
      "承認済みのフレンドは一覧から削除できます。送信中の申請は取り消せます。",
